...
class pay_class extends AWS_MODEL
{
	public function order($uid)
	{
		...
		return $this->insert('pay_account', array(
			'trade_sn' =>$trade_sn,
			'userid' => $uid,
			'ip'=>ip(),
			'addtime' => time()
	...
	public function publish_question($question_content, $question_detail, $category_id, $uid, $topics = null, $anonymous = null, $attach_access_key = null, $ask_user_id = null,$create_topic = true, $from = null,$mobile=null)
	{
		if ($question_id = $this->model('question')->save_question($question_content, $question_detail, $uid, $anonymous, null, $from,$mobile))
		{
